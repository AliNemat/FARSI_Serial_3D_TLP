module M_General
  ...
  implicit none 
  save
  integer     , parameter                           :: nx=270, ny=85, nz=127  !nx=191, ny=61, nz=91  !nx=211, ny=60, nz=71 !nx=191,ny=60  ,nz=91 !  ny=60  nz=91
  real(8)     , parameter                           :: Froude=(1.0/1.0)   
  real(8)     , parameter                           :: pi=3.141592653
  real(8)     , parameter                           :: Landa=Froude*110.166
  CHARACTER(*), parameter                           :: fileplace = "/home/ali/Research/2014/Dec/12th/Backup/"
